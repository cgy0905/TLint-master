...
/**
 * Created by cgy on 2018/12/31 下午 2:55.
 */
public class LoadMoreRecyclerView extends RecyclerView {
    ...
    public class AutoLoadAdapter extends Adapter<ViewHolder> {
         ...
         * 数据adapter
         */
        private Adapter mInternalAdaper;

        public AutoLoadAdapter(Adapter adapter) {
            mInternalAdaper = adapter;
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == TYPE_FOOTER) {
                ...
                return mInternalAdaper.onCreateViewHolder(parent, viewType);
            }
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if (type != TYPE_FOOTER) {
                mInternalAdaper.onBindViewHolder(holder, position);
            }
        }

        @Override
        public int getItemCount() {
            int count = mInternalAdaper.getItemCount();
