...
public class GreenDaoGenerator {
  ...
  public static final String GREEN_DAO_CODE_PATH = "../TLint-master/hupu/src/main/java";

  public static void main(String[] args) throws Exception {

    Schema schema = new Schema(VERSION, "com.cgy.hupu.db");
